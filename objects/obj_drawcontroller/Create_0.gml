...
array_push(objdark_arr, obj_gigacherrydead, obj_baddiespawner, obj_sucroseiceblock, obj_eyescreammine, obj_boxofpizza, obj_pizzaboxunopen, obj_rocket, obj_ratblock, obj_superspring);
