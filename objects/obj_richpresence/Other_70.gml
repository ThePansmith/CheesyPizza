		...
		if code_is_compiled() or DEBUG
		{
			...
			var lockout = [
				...
				*/
				...
				1141449907962662975, // cyancan1 (Brambles) 12 (greencheese associate, calling me groomer)
				
				// You know.
				516337795372154910, // Zerokizo 6
				698387118149599293, // Morris 7
				463132674995781637, // SpectralScrubs 8
				827041050555187210, // jared9994 9
				1137046644790153327, // alexdoesstuff 10
				1059165939234517093, // vir / l1laac_ 11
			];
