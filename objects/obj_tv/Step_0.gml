...
if (room == Realtitlescreen or room == Longintro or room == Mainmenu or room == rank_room or room == rm_levelselect or room == timesuproom or room == boss_room1 or room == characterselect or room == tower_extra or room == hub_loadingscreen or (string_copy(room_get_name(room), 1, 5) == "tower" && !global.panic))
{
	visible = false;
