...
{
	var i_love_cock = [obj_solid, obj_slope, obj_platform, obj_ladder, obj_secretblock, obj_secretbigblock, obj_secretmetalblock, obj_grindrail, obj_grindrailslope, obj_slope_platform, obj_hallway, obj_verticalhallway, obj_ladder];
	with all
	{
