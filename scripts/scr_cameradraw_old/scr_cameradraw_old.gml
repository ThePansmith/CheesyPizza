	...
	if instance_exists(player)
	{
		...
		switch player.character
		{
			...
			case "SP":
				...
				else if player.sprite_index == player.spr_victory or _state == states.keyget or _state == states.smirk or _state == states.gottreasure or (_state = states.bossintro && player.sprite_index == spr_player_levelcomplete)
			...
			case "PN":
			/*
				if player.sprite_index == spr_knightpepthunder
					hudface = spr_pinolinoHUDthunder
				else if player.sprite_index != spr_knightpepstart && (_state == states.knightpep or _state == states.knightpepslopes)
				...
				//else if player.sprite_index == spr_victory or _state == states.keyget or _state == states.smirk or _state == states.gottreasure or player.sprite_index == spr_playerPN_levelcomplete
				//	hudface = spr_pinolinoHUDhappy
				else if player.sprite_index == player.spr_machroll or player.sprite_index == player.spr_tumble
					hudface = spr_pinolinoHUDrolling
				//else if (player.supercharged && !global.heatmeter) or global.stylethreshold == 2
				//	hudface = spr_pinolinoHUDmenacing
				else if _state == states.mach1 or _state == states.chainsaw or _state == states.freefallprep or _state == states.freefall or _state == states.tackle or _state == states.Sjump or _state == states.slam or _state == states.Sjumpprep or _state == states.grab or _state == states.punch or _state == states.backbreaker or _state == states.backkick or _state == states.uppunch or _state == states.shoulder
				or player.sprite_index == player.spr_mach1
					hudface = spr_pinolinoHUDmach1
				else if _state == states.mach2 or player.sprite_index == player.spr_dive or player.sprite_index == player.spr_machslideboost or _state == states.climbwall or _state == states.handstandjump or _state == states.superslam 
					hudface = spr_pinolinoHUDmach2
				else if _state == states.mach3 && player.sprite_index == player.spr_crazyrun 
					hudface = spr_pinolinoHUDmach4
				else if _state == states.mach3 or player.sprite_index == player.spr_mach3boost
					hudface = spr_pinolinoHUDmach3
				//else if _state == states.hurt or player.sprite_index == spr_bombpepend or player.sprite_index == spr_fireassend or _state == states.timesup or _state == states.bombpep
				//	hudface = spr_pinolinoHUDhurt
				//else if player.angry or global.stylethreshold == 1
				//	hudface = spr_pinolinoHUD3hp
				//else if player.sprite_index == spr_hurtidle or player.sprite_index == spr_hurtwalk
				//	hudface = spr_pinolinoHUD1hp
				else if global.panic or global.snickchallenge or global.miniboss or global.stylethreshold >= 3
					hudface = spr_pinolinoHUDpanic
				//else if player.sprite_index == spr_shotgunpullout
				//	hudface = spr_pinolinoHUDmenacing
				else
