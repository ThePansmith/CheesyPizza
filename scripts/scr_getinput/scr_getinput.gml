...
function scr_getinput(is_menu = false)
{
	...
	key_shoot = tdp_input_get("player_shoot").held || tdp_input_get("player_shoot").held;
	key_shoot2 = tdp_input_get("player_shoot").pressed || tdp_input_get("player_shoot").pressed;
	key_start = tdp_input_get("menu_start").pressed || tdp_input_get("menu_startC").pressed;	
