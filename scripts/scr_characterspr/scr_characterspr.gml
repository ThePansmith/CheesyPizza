function scr_characterspr()
{
	...
	if (character == "PN")
	{
		...
		spr_crouchjump = spr_playerPN_crouchjump;
		spr_crouchfall = spr_playerPN_crouchfall;
		spr_couchstart = spr_playerPN_couchstart;
		spr_land = spr_playerPN_land;
		spr_land2 = spr_playerPN_land2;
		spr_lookdoor = spr_playerPN_lookdoor;
		spr_walkfront = spr_playerPN_walkfront;
		spr_victory = spr_playerPN_victory;
		spr_Ladder = spr_playerPN_ladder;
		spr_laddermove = spr_playerPN_laddermove;
		spr_ladderdown = spr_playerPN_ladderdown;
		spr_keyget = spr_playerPN_keyget;
		spr_crouchslip = spr_playerPN_crouchslip;
		...
		spr_machslidestart = spr_playerPN_machslidestart;
		spr_machslide = spr_playerPN_machslide;
		spr_machslideend = spr_playerPN_machslideend;
		spr_machslideboost = spr_playerPN_machslideboost;
		spr_stomp = spr_playerPN_stomp;
		spr_stompprep = spr_playerPN_stompprep;
		//spr_crouchslide = spr_playerPN_crouchslide;
		spr_crouch = spr_playerPN_crouch;
		//spr_bump = spr_playerPN_bump;
		spr_victory = spr_playerPN_victory;
		spr_hurt = spr_playerPN_hurt;
		spr_climbwall = spr_playerPN_climbwall;
		spr_mach2jump = spr_playerPN_mach2jump;
		...
		//spr_bossintro = spr_playerPN_bossintro;
		spr_hurtidle = spr_playerPN_hurtidle;
		spr_hurtwalk = spr_playerPN_hurtwalk;
		//spr_suplexmash1 = spr_playerPN_suplexmash1;
		//spr_suplexmash2 = spr_playerPN_suplexmash2;
		//spr_suplexmash3 = spr_playerPN_suplexmash3;
		//spr_suplexmash4 = spr_playerPN_suplexmash4;
		spr_keyget = spr_playerPN_keyget;
		spr_idle1 = spr_playerPN_idlefrown;
		spr_idle2 = spr_playerPN_idledance;
		spr_idle3 = spr_playerPN_handgesture1;
		spr_idle4 = spr_playerPN_handgesture2;
		spr_idle5 = spr_playerPN_handgesture3;
		spr_idle6 = spr_playerPN_handgesture4;
		spr_piledriver = spr_playerPN_piledriver;
		spr_piledriverland = spr_playerPN_piledriverland;
		...
		//spr_mach3hit = spr_playerPN_mach3hit;
		...
		spr_knightpepupslope = spr_knightpep_upslope;
		spr_bodyslamfall = spr_playerPN_bodyslamfall;
		spr_bodyslamstart = spr_playerPN_bodyslamstart;
		spr_bodyslamland = spr_playerPN_bodyslamland;
		spr_crazyrun = spr_playerPN_crazyrun;
		spr_fireass = spr_playerPN_fireass;
		spr_fireassground = spr_playerPN_fireassground;
		//spr_fireassend = spr_playerPN_idle;
		//spr_tumbleend = spr_playerPN_tumbleend;
		...
		spr_clownjump = spr_player_clownjump;
		spr_clownwallclimb = spr_player_clownwallclimb;
		spr_downpizzabox = spr_playerPN_downpizzabox;
		spr_uppizzabox = spr_playerPN_uppizzabox;
		...
		spr_suplexdashjump = spr_player_suplexgrabjump;
		spr_shotgunsuplexdash = spr_shotgun_suplexdash;
		spr_rollgetup = spr_playerPN_rollgetup;
		//spr_swingding = spr_playerPN_swingding;
		//spr_swingdingend = spr_playerPN_swingdingend;
		spr_haulingjump = spr_playerPN_haulingjump;
		spr_haulingidle = spr_playerPN_haulingidle;
		spr_haulingwalk = spr_playerPN_haulingwalk;
		spr_haulingstart = spr_playerPN_haulingstart;
		spr_haulingfall = spr_playerPN_haulingfall;
		spr_haulingland = spr_playerPN_haulingland;
		//spr_uppercutfinishingblow = spr_playerPN_uppercutfinishingblow;
		...
		//spr_facestomp = spr_playerPN_freefall;
		//spr_freefall = spr_playerPN_freefall2;
		spr_shotgunland = spr_shotgun_land;
		spr_shotgunshoot = spr_player_shotgun;
		spr_shotgunidle = spr_shotgun_idle;
		spr_shotgunwalk = spr_shotgun_walk;
		...
		spr_shotgungoduck = spr_shotgun_goduck;
		spr_fightball = spr_player_fightball;
		//spr_squished = spr_playerPN_squished;
		spr_supertaunt1 = spr_playerPN_supertaunt1;
		spr_supertaunt2 = spr_playerPN_supertaunt2;
		spr_supertaunt3 = spr_playerPN_supertaunt3;
		spr_supertaunt4 = spr_playerPN_supertaunt2;
		...
		spr_firemouthend = spr_playerPN_firemouthend;
		...
		//spr_barrelroll = spr_player_barrelroll;
		//spr_scaredjump1 = spr_playerPN_scaredjump1;
		//spr_scaredjump2 = spr_playerPN_scaredjump2;
		//spr_currentplayer = spr_playerPN_current;
		spr_golfidle = spr_playerPN_golfidle;
		spr_golfswing = spr_playerPN_golfswing;
		...
		spr_cheesepepstickceiling = spr_cheesepep_stickceilling;
		spr_cheesepepstickfloor = spr_cheesepep_stick;
		spr_rocketstart = spr_playerPN_rocketstart;
		spr_rocket = spr_playerPN_rocket;
		spr_rockethitwall = spr_playerPN_rockethitwall;
		spr_slipbanan1 = spr_playerPN_slipbanan1;
		spr_slipbanan2 = spr_playerPN_slipbanan2;
		spr_rageidle = spr_playerPN_rageidle;
		spr_ragemove = spr_playerPN_ragemove;
		spr_parry1 = spr_playerPN_parry1;
		spr_parry2 = spr_playerPN_parry2;
		spr_parry3 = spr_playerPN_parry3;
		spr_dead = spr_playerPN_deathend;
		spr_suplexbump = spr_playerPN_suplexbump;
		spr_grind = spr_playerPN_grind;
		spr_suplexland = spr_playerPN_machfreefall;
		//spr_superspringplayer = spr_playerPN_presentbox;
		...
		spr_breakdanceuppercut = spr_playerPN_breakdanceuppercut;
		spr_breakdanceuppercutend = spr_playerPN_breakdanceuppercutend;
		spr_poundcancel1 = spr_playerPN_poundcancel1;
		spr_poundcancel2 = spr_playerPN_poundcancel2;
		...
		spr_rampjump = spr_playerPN_rampjump;
		spr_wallsplat = spr_playerPN_wallsplat;
		spr_longjump = spr_playerPN_longjump;
		spr_longjumpend = spr_playerPN_longjumpend;
		spr_backslide = spr_playerPN_backslide;
		spr_backslideland = spr_playerPN_backslideland;
		spr_gnomecutscene1 = spr_playerPN_gnomecutscene1;
		spr_gnomecutscene2 = spr_playerPN_gnomecutscene2;
		spr_gnomecutscene3 = spr_playerPN_gnomecutscene3;
		spr_gnomecutscene4 = spr_playerPN_gnomecutscene4;
		//spr_screamtransition = spr_player_screamtransition;
		...
		spr_kungfuair2 = spr_playerPN_kungfuair2;
		spr_kungfuair3 = spr_playerPN_kungfuair3;
		...
		spr_chainsawidle = spr_playerPN_chainsawidle;
		spr_chainsawhit = spr_playerPN_chainsawhit;
		spr_chainsawhitwall = spr_playerPN_chainsawhitwall;
		spr_chainsawrev = spr_playerPN_chainsawrev;
		spr_chainsawdash = spr_playerPN_chainsawdash;
		spr_chainsawdashstart = spr_playerPN_chainsawdashstart;
		
		spr_lonegustavocrouchwalk = spr_lonegustavoPN_crouchwalk;
		spr_lonegustavohangwalk = spr_lonegustavoPN_hangwalk;
		spr_lonegustavodash = spr_lonegustavoPN_dash;
		spr_lonegustavopunch = spr_lonegustavoPN_punch;
		spr_lonegustavodashjump = spr_lonegustavoPN_dashjump;
		//spr_lonegustavostun = spr_lonegustavoPN_stun;
		spr_lonegustavoladder = spr_lonegustavoPN_ladder;
		spr_lonegustavohurt = spr_lonegustavoPN_hurt;
		spr_lonegustavogroundpound = spr_lonegustavoPN_groundpound;
		spr_lonegustavograbbable = spr_lonegustavoPN_grabbable;
		spr_lonegustavobump = spr_lonegustavoPN_bump;
		spr_lonegustavowalk = spr_lonegustavoPN_walk;
		spr_lonegustavocrouch = spr_lonegustavoPN_crouch;
		spr_lonegustavogroundpoundland = spr_lonegustavoPN_groundpoundland;
		spr_lonegustavomach3 = spr_lonegustavoPN_mach3;
		spr_lonegustavoidle = spr_lonegustavoPN_idle;
		spr_lonegustavokick = spr_lonegustavoPN_kick;
		spr_lonegustavoladderdown = spr_lonegustavoPN_ladderdown;
		spr_lonegustavogroundpoundstart = spr_lonegustavoPN_groundpoundstart;
		spr_lonegustavoskid = spr_lonegustavoPN_skid;
		spr_lonegustavojump = spr_lonegustavoPN_jump;
		spr_lonegustavohang = spr_lonegustavoPN_hang;
		//spr_lonegustavocrouchfall = spr_lonegustavoPN_crouchfall;
		spr_ratmount_treasureget = spr_gustavotreasureget;
		spr_ratmount_groundpound = spr_playerPN_ratmountgroundpound;
		spr_ratmount_land = spr_playerPN_ratmountland;
		spr_ratmount_bounceside = spr_playerPN_ratmountbounceside;
		//spr_ratmount_move2 = spr_playerPN_ratmountmove2;
		spr_ratmount_hurt = spr_playerPN_ratmounthurt;
		//spr_ratmount_idle2 = spr_playerPN_ratmountidle2;
		spr_ratmount_walljump = spr_playerPN_ratmountwalljump;
		spr_ratmount_attack = spr_playerPN_ratmountattack;
		spr_ratmount_jump = spr_playerPN_ratmountjump;
		spr_ratmount_idle = spr_playerPN_ratmountidle;
		//spr_ratmount_climbwall = spr_playerPN_ratmountclimbwall;
		spr_ratmount_dashjump = spr_playerPN_ratmountdashjump;
		spr_ratmount_taunt = spr_playerPN_ratmounttaunt;
		//spr_ratmount_jump2 = spr_playerPN_ratmountjump2;
		spr_ratmount_balloonend3 = spr_playerPN_ratmountballoonend3;
		spr_ratmount_supertaunt = spr_playerPN_ratmountsupertaunt;
		spr_ratmount_move = spr_playerPN_ratmountmove;
		spr_ratmount_mach3 = spr_playerPN_ratmountmach3;
		spr_ratmount_gameover = spr_playerPN_ratmountgameover;
		//spr_ratmount_idleanim = spr_playerPN_ratmountidleanim;
		//spr_ratmount_fall2 = spr_playerPN_ratmountfall2;
		spr_ratmount_bump = spr_playerPN_ratmountbump;
		spr_ratmount_balloonend1 = spr_playerPN_ratmountballoonend1;
		//spr_ratmount_timesup = spr_playerPN_ratmounttimesup;
		spr_ratmount_groundpoundfall = spr_playerPN_ratmountgroundpoundfall;
		spr_ratmount_spit = spr_playerPN_ratmountspit;
		spr_ratmount_bounce = spr_playerPN_ratmountbounce;
		spr_ratmount_balloonend2 = spr_playerPN_ratmountballoonend2;
		spr_ratmount_tumble = spr_playerPN_ratmounttumble;
		spr_ratmount_balloon = spr_playerPN_ratmountballoon;
		spr_ratmount_fall = spr_playerPN_ratmountfall;
		spr_ratmount_mushroombounce = spr_playerPN_ratmountmushroombounce;
		//spr_ratmount_swallow = spr_playerPN_ratmountswallow;
		spr_ratmountexitdoor = spr_ratmountPN_exitdoor;
		spr_ratmountenterdoor = spr_ratmountPN_enterdoor;
		spr_ratmountskid = spr_ratmountPN_skid;
		//spr_ratmountdoorclosed = spr_ratmountPN_doorclosed;
		//spr_ratmountentergate = spr_ratmountPN_entergate;
