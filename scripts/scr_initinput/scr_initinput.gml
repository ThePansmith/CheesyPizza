...
function scr_initinput(open_savedata = true)
{
    ...
    tdp_input_ini_read("menu_down", [tdp_action(tdp_type.keyboard, vk_down)]);
    tdp_input_ini_read("menu_left", [tdp_action(tdp_type.keyboard, vk_left)]);
    tdp_input_ini_read("menu_right", [tdp_action(tdp_type.keyboard, vk_right)]);
    tdp_input_ini_read("menu_start", [tdp_action(tdp_type.keyboard, vk_escape)]);
    tdp_input_ini_read("menu_select", [tdp_action(tdp_type.keyboard, ord("Z")), tdp_action(tdp_type.keyboard, vk_space)]);
    tdp_input_ini_read("menu_back", [tdp_action(tdp_type.keyboard, ord("X")), tdp_action(tdp_type.keyboard, vk_escape)]);
    ...
    tdp_input_ini_read("menu_downC", [tdp_action(tdp_type.joystick, gp_axislv, 1), tdp_action(tdp_type.gamepad, gp_padd)]);
    tdp_input_ini_read("menu_leftC", [tdp_action(tdp_type.joystick, gp_axislh, -1), tdp_action(tdp_type.gamepad, gp_padl)]);
    tdp_input_ini_read("menu_rightC", [tdp_action(tdp_type.joystick, gp_axislh, 1), tdp_action(tdp_type.gamepad, gp_padr)]);
    tdp_input_ini_read("menu_startC", [tdp_action(tdp_type.gamepad, gp_start)]);
    tdp_input_ini_read("menu_selectC", [tdp_action(tdp_type.gamepad, _select)]);
    ...
    tdp_input_ini_read("player_down", [tdp_action(tdp_type.keyboard, vk_down)]);
    tdp_input_ini_read("player_jump", [tdp_action(tdp_type.keyboard, ord("Z"))]);
    ...
    tdp_input_ini_read("player_rightC", [tdp_action(tdp_type.joystick, gp_axislh, 1), tdp_action(tdp_type.gamepad, gp_padr)]);
    tdp_input_ini_read("player_jumpC", [tdp_action(tdp_type.gamepad, gp_face1)]);
